      ...
      <div className="hero-content text-center text-neutral-content">
        <div className=" md:w-4/5 w-2/4 grid grid-cols-1 md:grid-cols-2  gap-28">
          ...
          <p className="mb-16 text-right md:mt-28 text-shadow  md:text-left md:text-6xl lg:w-96 text-xl  w-11/12 font-semibold ">
            <span className="text-blue-500">Unl</span ><span className="text-blue-300">eash</span> <br />
            <span className="text-blue-500">the</span> <span className="text-yellow-300">Future</span> <br />
            <span className="text-blue-500">of </span><span className="text-blue-200">Gatherings.</span>
          </p>
        </div>
      </div>
    </div>
