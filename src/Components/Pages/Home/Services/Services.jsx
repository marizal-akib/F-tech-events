...
const Services = ({ service }) => {
  ...
  return (
    <div
      ...
      className="border p-2 bg-fuchsia-900 border-fuchsia-700 hover:bg-opacity-10 bg-opacity-30 rounded-xl "
    >
      <div
      ...
      >
        <figure>
          <img className=" w-fit h-64" src={image} alt="name" />
        </figure>
        <div className="card-body">
          <h2 className="text-center mx-auto card-title text-amber-200">
            {name}
          </h2>
